...
**（中间）清理与归档**
- [x] **CLEAN-01**: `.planning/` 目录从 git 跟踪中移除，加入 `.gitignore`，本地保留供后续开发参考
- [x] **CLEAN-02**: 脱敏敏感文件名（unilever 等客户名出现在 archive 文件名中）
- [x] **CLEAN-03**: 添加 MIT LICENSE 文件
- [x] **CLEAN-04**: 所有决定公开的文档重写为开源使用者/贡献者友好标准
- [x] **CLEAN-05**: 其他内部文档归档（移入 .gitignore）
