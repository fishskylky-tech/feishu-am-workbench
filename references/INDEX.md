...
| [live-resource-links.md](./live-resource-links.md) | Actual URLs and tokens for the current personal Feishu environment (Base, folders, tasklist) | When the runtime needs concrete entry points to resolve resources |
